    ...
    <div class="container my-5">
        <div class="glass-container">
            ...
            <div class="mb-5">
                ...
                <div class="row g-3 justify-content-center">
                    ...
                    @foreach($categories as $category)
                        <div class="col-lg-2 col-md-3 col-6">
                            <a href="{{ route('pets.index') }}?category={{ $category->slug }}" class="text-decoration-none">
            ...
            @if($filteredPets->count() > 0)
                <h2 class="mb-4 fw-bold">Mavjud hayvonlar: <span class="text-muted fs-5">({{ $filteredPets->count() }})</span>
                </h2>
                <div class="row g-4">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card h-100 shadow-sm border-0">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <h5 class="card-title fw-bold mb-3">{{ $pet->name }}</h5>
                                    <div class="mb-3">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('pets.index') }}" class="btn btn-gradient">Barchasini ko'rish</a>
                </div>
            @endif
        </div>
    </div>
