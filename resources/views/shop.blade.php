    ...
    <div class="container my-5">
        <div class="glass-container">
            ...
            <div class="text-center mb-5">
                <h1 class="display-4 fw-bold mb-3">🛍️ Hayvonlar Do'koni</h1>
                <p class="lead text-muted">Orzuingizdagi do'stni toping va baxtli bo'ling!</p>
            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card h-100">
                                ...
                                <div class="position-relative overflow-hidden">
                                    @if($pet->image)
                                        <img src="{{ asset($pet->image) }}" class="card-img-top" alt="{{ $pet->name }}">
                                    @else
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mb-4">Ushbu kategoriyada hozircha hech qanday hayvon mavjud emas.</p>
                    <a href="{{ route('shop') }}" class="btn btn-gradient">
                        Barchasini ko'rish
                    </a>
                </div>
            @endif
